...
def get_all_ism_data():
    try:
        ...
        hospital_url = "https://www.ismworld.org/supply-management-news-and-reports/reports/ism-report-on-business/hospital/april/"
        hospital_old = None
        ...
        service_url = "https://www.ismworld.org/supply-management-news-and-reports/reports/ism-report-on-business/services/april/"
        service_old = None
        ...
        manuf_url = "https://www.ismworld.org/supply-management-news-and-reports/reports/ism-report-on-business/pmi/april/"
        manuf_old = None
        ...
        if not changes_found:
            notify_slack(f"ISM scraping completed at {datetime.now().strftime('%Y-%m-%d %H:%M:%S')} No changes were found in this website.")
